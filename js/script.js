...
function downloadURI(uri, uri2, name,name2) 
{
...
var Main = {
  ...
  careerF: function () {
    var careerSwiper = new Swiper(".career_slider", {
      slidesPerView: 3,
      centeredSlides: true,
      loop: true,
      loopAdditionalSlides: 1,
  ...
  employmentF: function () {
    ...
    var employmentSwiper = new Swiper(".employmentSwiper01", options);

    var employmentSwiper2 = new Swiper(".employmentSwiper02", options);
    employmentSwiper2.autoplay.stop();
    setTimeout(() => {
      employmentSwiper2.autoplay.start();
    }, 1500);
  },
  summaryF: function () {
